      ...
      <div className="flex flex-col w-full max-w-6xl md:min-h-[85vh] md:max-h-[90vh] bg-white md:shadow-xl md:border md:border-gray-200 md:rounded-xl overflow-hidden">
        <div className="px-4 sm:px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-white shrink-0">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500">
            ...
            >
              <path
                d="M221.7 0L-.003 127.998v255.997L221.7 512l221.696-128.005V127.998L221.7 0zm0 36.976l189.676 109.51v219.02L221.7 475.024 32.024 365.506v-219.02L221.7 36.976z"
                fill="#ff1e58"
              />
              <path
                d="M170.368 330.738h-31.12l74.405-149.483h31.127l-74.412 149.483zM289.052 330.738h-31.127l74.412-149.483h31.12l-74.405 149.483zM111.075 330.738H79.947l37.203-74.742h31.128l-37.203 74.742zM266.945 256.019h-31.128l37.203-74.742h31.128l-37.203 74.742z"
                fill="#ff1e58"
              />
            </svg>
